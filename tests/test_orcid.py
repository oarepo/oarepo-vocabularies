...
import os
import jsonschema
from oarepo_vocabularies.authorities import AuthorityProvider, ORCIDProvider
from requests.exceptions import HTTPError

from oarepo_vocabularies.authorities.providers.orcid_provider import (
    ORCIDProvider,
    ORCIDClient,
)
...
def test_orcid_provider_pagination(orcid_provider):
    ...
    # TODO: These assertions are susceptible to be volatile
