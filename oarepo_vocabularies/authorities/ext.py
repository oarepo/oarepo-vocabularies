...
class OARepoVocabulariesAuthorities(object):
    ...
    def auth_getter(self, app, vocabulary_type: str):
        ...
        authority_section = vocabularies_metadata[vocabulary_type].get("authority", None)
        
        return authority_section.get(obj_or_import_string("getter"), None) if authority_section else None
