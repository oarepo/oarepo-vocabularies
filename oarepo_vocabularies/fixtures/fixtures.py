...
# taken from invenio-rdm-records, will be removed when the code gets to vocabularies
# https://github.com/inveniosoftware/invenio-rdm-records/blob/master/invenio_rdm_records/fixtures/vocabularies.py
...
from .yaml_csv_json import JSONLinesIterator, YamlIterator, CSVIterator
from .excel import ExcelIterator
...
def create_iterator(data_file):
    ...
    if ext == ".yaml":
        ...
        return ExcelIterator(data_file)
...
class PrioritizedVocabulariesFixtures:
    ...
    def _entry_points(self):
        ...
        """
        # changed from rdm to oarepo_vocabularies
        return list(pkg_resources.iter_entry_points("oarepo_vocabularies.fixtures"))
