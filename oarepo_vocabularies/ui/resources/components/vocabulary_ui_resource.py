...
class VocabularyRecordsComponent(UIResourceComponent):
    ...
    def before_ui_search(self, *, extra_context, identity, search_options, view_args, **kwargs):
    ...
    def before_ui_detail(self, *, extra_context, identity, view_args, api_record, **kwargs):
        vocabulary_type = view_args["vocabulary_type"]
        api_service = self.resource.api_service
        search_options = dict(
